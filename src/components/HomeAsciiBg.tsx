...
const MASK_SELECTORS =
  "nav, .site-nav, .site-header, .h-sub, .h-actions, .s-head, .s-head-row, .s-sub, .about-grid, .showcase, .showcase-carousel, #guides, .guide-card, .foot, .foot-start, .site-copyright, .newsletter, #contact, " +
